  ...
  return (
    <div className="bg-secondary px-6 py-10 rounded-2xl flex flex-col gap-4 items-center md:flex-row md:justify-between md:px-20"> 
      ...
      <div className="flex justify-center items-center gap-3">
        <a className="w-[8rem] h-[2.93rem] md:w-[13.625rem] md:h-[5rem]" href="https://apps.apple.com/jp/app/%E3%83%91%E3%83%AD%E3%83%83%E3%83%88-%E3%81%BF%E3%82%93%E3%81%AA%E3%81%AE%E6%96%B9%E8%A8%80%E8%BE%9E%E5%85%B8/id6462151090" target="_blank" rel="noopener noreferrer">
          <Image src={appstore} alt="パロットロゴ" className="object-cover h-full w-full"/>
        </a>
        <a className="w-[9.8rem] h-[3.75rem] md:w-[16.875rem] md:h-[6.5rem]">
